...
func (x *Comment) TableName() string {
	return "comment"
}
...
func (x *DouyinCommentActionRequest) Reset() {
	*x = DouyinCommentActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[0]
...
func (*DouyinCommentActionRequest) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{0}
}
...
type DouyinCommentActionResponse struct {
	...
	Comment    *CommentDto `protobuf:"bytes,3,opt,name=Comment,proto3" json:"Comment,omitempty"`                          // 评论成功返回评论内容，不需要重新拉取整个列表
}

func (x *DouyinCommentActionResponse) Reset() {
	*x = DouyinCommentActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinCommentActionResponse) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{1}
}
...
func (x *DouyinCommentActionResponse) GetComment() *CommentDto {
	if x != nil {
		return x.Comment
	}
	return nil
...
func (x *DouyinCommentListRequest) Reset() {
	*x = DouyinCommentListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinCommentListRequest) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{2}
}
...
type DouyinCommentListResponse struct {
	...
	StatusCode  int32         `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"` // 状态码，0-成功，其他值-失败
	StatusMsg   string        `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`     // 返回状态描述
	CommentList []*CommentDto `protobuf:"bytes,3,rep,name=comment_list,json=commentList,proto3" json:"comment_list"`         // 评论列表
}

func (x *DouyinCommentListResponse) Reset() {
	*x = DouyinCommentListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinCommentListResponse) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{3}
}
...
func (x *DouyinCommentListResponse) GetCommentList() []*CommentDto {
	if x != nil {
...
type Comment struct {
	...
	Cancel     int64  `protobuf:"varint,5,opt,name=cancel,proto3" json:"cancel,omitempty"`
...
func (x *Comment) Reset() {
	*x = Comment{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Comment) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{5}
}
...
func (x *CommentDto) Reset() {
	*x = CommentDto{}
	if protoimpl.UnsafeEnabled {
		mi := &file_idl_pb_comment_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CommentDto) Descriptor() ([]byte, []int) {
	return file_idl_pb_comment_proto_rawDescGZIP(), []int{6}
}

func (x *CommentDto) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *CommentDto) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *CommentDto) GetCreateData() string {
	if x != nil {
		return x.CreateData
	}
	return ""
...
var File_idl_pb_comment_proto protoreflect.FileDescriptor

var file_idl_pb_comment_proto_rawDesc = []byte{
	0x0a, 0x14, 0x69, 0x64, 0x6c, 0x2f, 0x70, 0x62, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x8f, 0x01, 0x0a, 0x1e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x2d, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x65, 0x6e, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x44, 0x74, 0x6f, 0x52, 0x07,
	0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x4e, 0x0a, 0x1b, 0x64, 0x6f, 0x75, 0x79, 0x69,
	...
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x96, 0x01, 0x0a, 0x1c, 0x64, 0x6f, 0x75, 0x79,
	...
	0x44, 0x74, 0x6f, 0x52, 0x0b, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa0, 0x01, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	...
	0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x12, 0x17,
	0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x7a, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x6d, 0x65,
	0x6e, 0x74, 0x44, 0x74, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	...
	0x61, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44,
	0x61, 0x74, 0x61, 0x32, 0xce, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x53,
	0x72, 0x76, 0x12, 0x62, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41, 0x63, 0x74,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x5c, 0x0a, 0x0b, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x24, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e,
	0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c,
	0x69, 0x73, 0x74, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x25, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x6d,
...
var (
	file_idl_pb_comment_proto_rawDescOnce sync.Once
	file_idl_pb_comment_proto_rawDescData = file_idl_pb_comment_proto_rawDesc
)

func file_idl_pb_comment_proto_rawDescGZIP() []byte {
	file_idl_pb_comment_proto_rawDescOnce.Do(func() {
		file_idl_pb_comment_proto_rawDescData = protoimpl.X.CompressGZIP(file_idl_pb_comment_proto_rawDescData)
	})
	return file_idl_pb_comment_proto_rawDescData
}

var file_idl_pb_comment_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_idl_pb_comment_proto_goTypes = []interface{}{
	...
	(*User)(nil),                        // 4: comment.User
	(*Comment)(nil),                     // 5: comment.Comment
	(*CommentDto)(nil),                  // 6: comment.CommentDto
}
var file_idl_pb_comment_proto_depIdxs = []int32{
	6, // 0: comment.douyin_comment_action_response.Comment:type_name -> comment.CommentDto
	6, // 1: comment.douyin_comment_list_response.comment_list:type_name -> comment.CommentDto
	4, // 2: comment.CommentDto.user:type_name -> comment.User
...
func init() { file_idl_pb_comment_proto_init() }
func file_idl_pb_comment_proto_init() {
	if File_idl_pb_comment_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_idl_pb_comment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_pb_comment_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_pb_comment_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_pb_comment_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_pb_comment_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
		...
		file_idl_pb_comment_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_idl_pb_comment_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_idl_pb_comment_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_idl_pb_comment_proto_goTypes,
		DependencyIndexes: file_idl_pb_comment_proto_depIdxs,
		MessageInfos:      file_idl_pb_comment_proto_msgTypes,
	}.Build()
	File_idl_pb_comment_proto = out.File
	file_idl_pb_comment_proto_rawDesc = nil
	file_idl_pb_comment_proto_goTypes = nil
	file_idl_pb_comment_proto_depIdxs = nil
}
